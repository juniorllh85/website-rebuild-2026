      ...
      <div className="mx-auto max-w-6xl px-4 py-10 text-sm flex flex-col sm:flex-row gap-8 sm:items-center sm:justify-between">
        <div className="space-y-4">
          <div>
            ...
            <p className="mt-1 text-white/60">501(c)(3) Nonprofit Organization • EIN: 35-2905128</p>
            <p className="mt-1 text-white/60">info@thegoldenyearsfoundation.com</p>
            <p className="mt-1 text-white/60">Miami-Dade County, Florida</p>
          </div>
        ...
        <div className="flex flex-col gap-3 text-white/80">
          ...
          <button onClick={onPrivacyClick} className="hover:text-emerald-400 text-left transition-colors">
            Privacy Policy
          </button>
        </div>
      </div>
